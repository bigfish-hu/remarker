(function($){
    ...
    var settings = $.extend({
			...
			tpl: {
				description: '{{ include("description.twig")|escape("slash")|raw }}',
				highlighter: '{{ include("highlighter.twig")|escape("slash")|raw }}',
				overview: '{{ include("overview.twig")|escape("slash")|raw }}',
				submitSuccess: '{{ include("submit_success.twig")|escape("slash")|raw }}',
				submitError: '{{ include("submit_error.twig")|escape("slash")|raw }}'
			},
			onClose: 				function() {},
            ...
            if (fv.major > 0) {
				...
				$(document).on('click', '#feedback-submit', function() {
					...
					if ($('#feedback-note').val().length > 0) {
						...
						post.attributes.screenshot = img.replace("data:image/png;base64,", "");
;
